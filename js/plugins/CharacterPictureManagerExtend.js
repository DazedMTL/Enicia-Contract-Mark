...
(() => {
  ...
  function getFileNo(actor, param) {
    ...
    if (forceCloth) {
      ...
      if (forceCloth == "sister") {
        forceBody = Stripflag1 && Stripflag2 ? 294 : 5;//踊り子
        forceLeg = 22;
