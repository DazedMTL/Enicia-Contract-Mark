...
var effekseer = function () {
  var Module = {}; var Core = {}; var _imageCrossOrigin = "use-credentials"; var _onloadAssembly = function _onloadAssembly() { }; var _onerrorAssembly = function _onerrorAssembly() { }; var _is_runtime_initialized = false; var _onRuntimeInitialized = function _onRuntimeInitialized() {
  ...
  var EffekseerEffect = function () {
    ...
    }, { key: "disableVAO", value: function disableVAO() { if (this.ext_vao != null) { this.ext_vao.bindVertexArrayOES(null); } else if (this.isWebGL2VAOEnabled) { this.gl.bindVertexArray(null); } } }]); return ContextStates;
    ...
    _createClass(EffekseerContext, [{
      ...
      key: "init", value: function init(webglContext, settings) {
        this.gl = webglContext; this.contextStates = new ContextStates(this.gl); var instanceMaxCount = 4000; var squareMaxCount = 10000; var enableExtensionsByDefault = true; if (settings) {
      ...
      key: "draw", value: function draw() {
        this._makeContextCurrent(); var program = null; if (this._restorationOfStatesFlag) { program = this.gl.getParameter(gl.CURRENT_PROGRAM); this.contextStates.save(); } else { this.contextStates.disableVAO(); }
        Core.Draw(this.nativeptr); if (this._restorationOfStatesFlag) { this.contextStates.restore(); this.gl.useProgram(program); }
      }
    }, {
      key: "beginDraw", value: function beginDraw() {
        if (this._restorationOfStatesFlag) { this.contextStates.save(); } else { this.contextStates.disableVAO(); }
        Core.BeginDraw(this.nativeptr);
      }
    }, { key: "endDraw", value: function endDraw() { Core.EndDraw(this.nativeptr); if (this._restorationOfStatesFlag) { this.contextStates.restore(); } } }, {
    ...
    }, { key: "resetBackground", value: function resetBackground() { return Core.ResetBackground(this.nativeptr); } }]); return EffekseerContext;
  }(); var Effekseer = function () {
